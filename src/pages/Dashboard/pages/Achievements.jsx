                            ...
                            <div>
                                {
                                    ...
                                    <Tile
                                        ...
                                        editIcon={<PencilIcon width={15} height={15} className='text-blue-500 cursor-pointer'/>}
                                        trashIcon={<TrashIcon width={15} height={15} className='text-red-500 cursor-pointer'/>}
